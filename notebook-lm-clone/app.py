...
section[data-testid="stSidebar"] {
    background-color: #1e1f24 !important;  /* lite dark */
}
...
div[data-testid="stAlert"] > div {
    background-color: #123d2a !important;
    color: #3cff9e !important;
}
...
/* Section headings: Add sources, Upload sources, Website URLs */
h3, h4 {
    font-weight: 400 !important;   /* normal */
    color: #e5e7eb !important;     /* bright, clean */
}
...
/* Drag & drop box background */
div[data-testid="stFileUploader"] section {
    background-color: #2a2e36 !important;
}

/* Drag & drop text (brighter, NOT bold) */
...
/* Website URLs – remove ALL borders */
...
div[data-testid="stButton"] button {
    background-color: #3ba3f5 !important; /* sky blue */
...
/* Hover effect (slightly darker sky blue) */
div[data-testid="stButton"] button:hover {
    background-color: #2f8fe0 !important;
}
            
/* Browse files button inside drag & drop */
...
/* FORCE Website URLs description */
.website-urls-desc {
    color: #ffffff !important;
    font-weight: 400 !important;
    opacity: 1 !important;
...
.youtube-heading {
    font-size: 24px;              /* Same visual scale as Website URLs */
    font-weight: 400 !important;  /* Normal like Website URLs */
    color: #e5e7eb !important;    /* Same brightness */
    margin-bottom: 8px;
}

.youtube-desc {
    font-size: 14px;              /* Match description size */
    font-weight: 400;
    color: #e5e7eb;
    opacity: 0.9;
    margin-bottom: 12px;
...
.paste-text-desc {
    ...
    margin-bottom: 10px;
            ...
            /* ================= PODCAST SELECT LABEL FIX ================= */

/* Selectbox label text (e.g. "Select source for podcast") */
div[data-testid="stSelectbox"] label {
    color: #e5e7eb !important;   /* bright */
    font-weight: 400 !important; /* normal (not bold) */
    font-size: 14px;
    opacity: 1 !important;
}
/* Selectbox main background */
div[data-baseweb="select"] > div {
    background-color: #2a2e36 !important;  /* lite dark */
    border: none !important;
}
...
ul[role="listbox"] {
    background-color: #1e1f24 !important;
            ...
            /* Selectbox container */
div[data-baseweb="select"] > div {
    background-color: #2b2f36 !important;   /* lite dark */
    border: none !important;
}
...
div[data-baseweb="select"] > div {   # arrow 3 boxes
...
div[data-testid="stFileUploaderFileName"] {
    color: #e5e7eb !important;   /* bright white */
    font-weight: 400 !important; /* normal */
}

/* File size / meta text */
div[data-testid="stFileUploaderFileName"] + div {
    color: #cbd5e1 !important;   /* slightly softer */
    font-weight: 400 !important;
}
/* FORCE Chat helper text brightness */
[data-baseweb="typo"] {
    color: #e5e7eb !important;
    font-weight: 400 !important;
    opacity: 1 !important;
}
/* ================= WEBSITE URL TEXTAREA FOCUS ================= */

/* Ensure caret (| cursor) is visible */
div[data-testid="stTextArea"] textarea {
    caret-color: #ff4d4f !important;   /* red cursor */
}

/* Focus effect (lite red border + glow) */
div[data-testid="stTextArea"] textarea:focus {
    border: 1px solid #ff4d4f !important;
    box-shadow: 0 0 0 1px rgba(255, 77, 79, 0.5) !important;
    outline: none !important;
}

/* Keep text bright & normal */
div[data-testid="stTextArea"] textarea,
div[data-testid="stTextArea"] textarea::placeholder {
    color: #e5e7eb !important;
    font-weight: 400 !important;
...
def render_source_upload_dialog():
    ...
    with tab1:
        ...
        st.markdown(
            "<div class='website-urls-desc'>Paste in Web URLs below to upload as sources</div>",
            unsafe_allow_html=True
        )
    ...
    with tab2:
        st.markdown('<div class="youtube-heading">YouTube Videos</div>', unsafe_allow_html=True)
        st.markdown(
            '<div class="youtube-desc">Paste YouTube URL</div>',
            unsafe_allow_html=True
        )
    ...
    with tab3:
        st.markdown(
            '<div class="paste-heading">Paste copied text</div>',
            unsafe_allow_html=True
        )
        st.markdown(
            '<div class="paste-text-desc">Paste copied text to upload as a source</div>',
            unsafe_allow_html=True
        )
